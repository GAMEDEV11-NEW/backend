...
console.log('🎮 Testing Separate Gameplay Service...\n');
...
socket.on('connect', () => {
    ...
    // Test gameplay event with separate service
    testGameplayEvent();
});
...
function testGameplayEvent() {
    console.log('\n🎯 Testing get_game_data event (Separate Service)...');
    
    const testData = {
        user_id: "test_user_456",
        service_type: "separate_gameplay_service",
...
socket.on('game_data_response', (response) => {
    ...
    console.log('\n📊 Service Info:');
    console.log('✅ Using separate GameplayService');
    console.log('✅ Events stored in gameplay_events collection');
